...
namespace SwachBharat.CMS.Dal.DataContexts
{
    ...
    public partial class DevChildSwachhBharatNagpurEntities : DbContext
    {
       ...
       : base(SwachBharatAppConnection.GetConnectionString(AppId))
        ...
        public virtual ObjectResult<SP_CTPTEmployeeSummary_Result> SP_CTPTEmployeeSummary(Nullable<System.DateTime> from, Nullable<System.DateTime> to, Nullable<int> userid, string emptype)
        {
            var fromParameter = from.HasValue ?
                new ObjectParameter("from", from) :
                new ObjectParameter("from", typeof(System.DateTime));
