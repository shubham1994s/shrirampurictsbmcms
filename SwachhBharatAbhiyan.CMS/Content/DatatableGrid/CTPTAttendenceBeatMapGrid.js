$(document).ready(function () {
    ...
    $("#demoGrid").DataTable({
        ...
        "ajax": {
            "url": "/Datable/GetJqGridJson?rn=CTPTAttendence",
            "type": "POST",
            "datatype": "json"
        },
...
function user_route(id) {
    window.location.href = "/AttendenceBeatMap/CTPTUserRoute?daId=" + id;
};

function house_route(id) {
    window.location.href = "/AttendenceBeatMap/CTPTRoute?daId=" + id;
};
function map(a) {
